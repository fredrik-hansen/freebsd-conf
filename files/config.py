...
keys = [
    ...
    # Size
    Key([mod, "control"], "Right", lazy.layout.shrink(), desc="Grow window to the left"),
    Key([mod, "control"], "Left", lazy.layout.grow(), desc="Grow window to the right"),
    ...
    Key(["control"], "Right", lazy.screen.next_group(skip_empty=True) , desc="Next workspace"),
    Key(["control"], "Left", lazy.screen.prev_group(skip_empty=True) , desc="Prev workspace"),

    #System
    Key([mod], "q", lazy.window.kill(), desc="Kill focused window"),
    Key([mod, "shift"], "r", lazy.reload_config(), desc="Reload the config"),
    Key([mod, "control"], "q", lazy.spawn(home + "/.config/qtile/scripts/powermenu.sh"), desc="Open Powermenu"),
    Key([mod, "control"], "p", lazy.spawn(home + "/.config/qtile/scripts/rofipass.sh"), desc="Passwords"),
    # Apps
    Key([mod], "Return", lazy.spawn(terminal), desc="Launch terminal"),
    Key([mod], "r", lazy.spawn("rofi -show drun"), desc="Launch Rofi"),
    Key([mod], "b", lazy.spawn("sh " + home + "/.config/.settings/browser.sh"), desc="Launch Browser"),
...
widget_list = [
    ...
    widget.TextBox(
       **decor_left,
       ...
       padding=10,
       fontsize=fnt_scale*24,
       mouse_callbacks={"Button1": lambda: qtile.spawn("pactl set-sink-volume @DEFAULT_SINK@ +10%")},
    ),
    widget.TextBox(
       **decor_left,
       background=Color4+".4",  
    ...
    widget.TextBox(
        **decor_left,
        ...
        text="  ",
        foreground="000000.6",
        fontsize=fnt_scale*28,
        mouse_callbacks={"Button1": lambda: qtile.spawn(home + "/.config/qtile/scripts/wallpaper.sh select")},
    ),
    ...
    widget.TextBox(
        **decor_left,
        ...
        foreground="000000.6",
        fontsize=fnt_scale*28,
        mouse_callbacks={"Button1": lambda: qtile.spawn("bash " + home + "/.config/.settings/browser.sh")},
    ),
    widget.TextBox(
        **decor_left,
        background="#ffffff.4",
        ...
        foreground="000000.6",
        fontsize=fnt_scale*28,
        mouse_callbacks={"Button1": lambda: qtile.spawn("bash " + home + "/.config/.settings/filemanager.sh")}
    ),
